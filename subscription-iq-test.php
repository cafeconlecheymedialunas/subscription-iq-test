 ...
 */
function deactivate_subscription_iq_test() {
...
register_activation_hook( __FILE__, 'activate_subscription_iq_test' );
register_deactivation_hook( __FILE__, 'deactivate_subscription_iq_test' );
 ...
 * @since    1.0.0
 */
function run_subscription_iq_test() {

	$plugin = new Subscription_Iq_Test();
	$plugin->run();

}
run_subscription_iq_test();
